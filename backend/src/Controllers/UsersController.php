...
class UsersController extends ApiController
{
    ...
    public function __construct(ApiPolicy $apiPolicy, IUsersService $usersService, IAuthenticationService $authenticationService, IImagesService $imagesService)
    {
    ...
    public function portfolio()
    {
        ...
        $dtosArray = $this->imagesService->getAllImagesFromUserId($loggedInUser->getUserId(), empty($data["page"]) ? null : $data["page"] , empty($data["pageSize"]) ? null : $data["pageSize"]);
